...
<header>
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark py-3">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                         <a class="nav-link active" href="sent request.php">Sent Request</a>
                    </li>
    ...
    <?php
        include("../connection.php");
            ...
            $query = "select * from request where bid = $bid";
            ...
            while($row = mysqli_fetch_array($r))
            {
                ...
                $query2 = "select * from member,cars where member.id = $sid and cars.p_id = $pid";
                ...
                echo "<tr>
                    ...
                    else if($row['status'] == 2) echo "<td><p style='color: red;'>Rejected</p></td>";
